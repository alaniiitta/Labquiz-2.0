...
const topics=[
 {id:1,title:"Conceptos básicos",priority:"Alta",progress:82,questions:68,summary:"Muestras, características, análisis y valores clave."},
 {id:2,title:"Líquidos biológicos",priority:"Media",progress:38,questions:54,summary:"ADN, ARN, replicación, expresión y técnicas moleculares."},
 {id:3,title:"Análisis urinario y función renal",priority:"Media",progress:45,questions:61,summary:"Respuesta inmune, anticuerpos, complemento y técnicas."},
 {id:4,title:"Función digestiva",priority:"Alta",progress:56,questions:76,summary:"Células sanguíneas, hemograma, coagulación y diagnóstico."},
 {id:5,title:"Función hepática y proteínas",priority:"Alta",progress:71,questions:54,summary:"Bilirrubina, enzimas, proteínas y pruebas hepáticas."},
 {id:6,title:"Enzimas",priority:"Media",progress:41,questions:49,summary:"Filtrado glomerular, función tubular y marcadores."},
 {id:7,title:"Técnicas Instrumentales",priority:"Alta",progress:63,questions:91,summary:"Cultivos, identificación, antibiograma y control de calidad."},
 {id:8,title:"Hematología",priority:"Baja",progress:22,questions:43,summary:"Parásitos de interés clínico y métodos diagnósticos."},
 {id:9,title:"Coagulación",priority:"Alta",progress:58,questions:72,summary:"Metabolitos, enzimas, perfiles y control analítico."},
 {id:10,title:"Banco de sangre",priority:"Media",progress:34,questions:47,summary:"Tira reactiva, sedimento y principales alteraciones."},
 {id:11,title:"Inmunología",priority:"Baja",progress:19,questions:52,summary:"Hormonas, ejes endocrinos y pruebas funcionales."},
 {id:12,title:"Serología",priority:"Alta",progress:49,questions:65,summary:"Grupos sanguíneos, compatibilidad y transfusión."},
 {id:13,title:"Bacteriología",priority:"Baja",progress:18,questions:39,summary:"Antígenos, anticuerpos y pruebas pretransfusionales."},
 {id:14,title:"Parásitos, hongos y virus",priority:"Media",progress:31,questions:57,summary:"Procesamiento de muestras y diagnóstico microbiológico."},
 {id:15,title:"Equilibrio ácido-base e iones",priority:"Baja",progress:14,questions:45,summary:"Virus de interés clínico y métodos de detección."},
 {id:16,title:"Metabolismo lipídico",priority:"Baja",progress:11,questions:37,summary:"Hongos patógenos y diagnóstico de laboratorio."},
 {id:17,title:"Metabolismo hidratos de carbono",priority:"Media",progress:27,questions:42,summary:"Procesamiento, tinciones y reconocimiento citológico."},
 {id:18,title:"Hormonas",priority:"Media",progress:24,questions:51,summary:"Procesamiento histológico y técnicas auxiliares."},
 {id:19,title:"Genética",priority:"Alta",progress:52,questions:58,summary:"Control de calidad, errores, trazabilidad y seguridad."},
 {id:20,title:"Reproducción y cribados",priority:"Media",progress:36,questions:44,summary:"Bioseguridad, residuos, prevención y actuación."},
 {id:21,title:"Drogas de abuso y Fármacos",priority:"Media",progress:29,questions:63,summary:"Equipos, calibración, mantenimiento y principios analíticos."},
 {id:22,title:"Marcadores tumorales",priority:"Alta",progress:67,questions:46,summary:"Preanalítica, identificación, transporte y conservación."},
