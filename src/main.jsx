...
function ProgressPage(){return <div><section className="section card"><h3>Sin datos de progreso</h3><p>El progreso aparecerá cuando completes tus primeros tests.</p></section></div>}
