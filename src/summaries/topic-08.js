export default {
  ...
  sections: [
    ...
    {
      heading: "Velocidad de sedimentación globular (VSG)",
      points: [
    ...
    },
    {
      ...
      points: [
        ...
        "Frotis o extensión de sangre periférica: tinciones panópticas con **eosina** (ácida, tiñe de rojo componentes basófilos como la hemoglobina) y **azul de metileno** (básico, tiñe de azul los ácidos nucleicos): Giemsa, May-Grünwald, May-Grünwald-Giemsa, Wright, Romanowsky.",
    ...
    },
    {
      ...
      points: [
        ...
        "Eritropoyesis regulada por **eritropoyetina (EPO)**, síntesis renal: proeritroblasto → eritroblasto basófilo (inicia síntesis de Hb) → eritroblasto policromatófilo (__último con capacidad mitótica__) → eritroblasto ortocromático/normoblasto → reticulocito (contiene ARN, se tiñe con azul de cresil) → eritrocito.",
    ...
    },
    {
      ...
      points: [
        ...
        "Forma: __poiquilocitosis si el origen es adquirido__ (no aparece si es congénito). Ovalocitos/eliptocitos, acantocitos (hepatopatías graves), estomatocitos (↑permeabilidad al Na, alcoholismo), equinocitos (déficit de ATP o piruvato quinasa), dianocitos (talasemia, HbC), esquistocitos y dacriocitos (CID, mielofibrosis), **drepanocitos (HbS)**, **esferocitos** (esferocitosis hereditaria).",
    ...
    {
      heading: "Metabolismo del hierro",
      points: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Anemias hemolíticas**: ↑LDH, ↓haptoglobina, ↑bilirrubina indirecta, ↑reticulocitos. Causas intracorpusculares (déficit de G6PDH, déficit de piruvato quinasa, hemoglobinuria paroxística nocturna) o extracorpusculares (autoinmunes, mecánicas).",
    ...
    },
    {
      ...
      points: [
        "**Talasemias** (cuantitativas): defecto en la síntesis de una cadena de globina. **Alfa-talasemia**: formas HbH y Hb Bart (hydrops fetalis, incompatible con la vida). **Beta-talasemia**: más frecuente en nuestro medio; forma homocigota grave (**anemia de Cooley**) con HbA2 elevada.",
    ...
    {
      heading: "Funciones de granulocitos, monocitos y linfocitos",
      points: [
    ...
    {
      heading: "Leucemias, linfomas y síndromes mielodisplásicos/mieloproliferativos",
      points: [
    ...
    },
    {
      ...
      points: [
        ...
        "Citoquímica: **mieloperoxidasa** y **Sudán negro B** (blastos mieloides), **PAS en bloques** (linfoblastos y eritroblastos), **TdT** (positiva en linfoblastos), **fosfatasa alcalina granulocitaria** (baja en LMC, alta en reacciones neutrofílicas secundarias) y **fosfatasa ácida resistente a tartrato** (tricoleucemia).",
    ...
    },
    {
      ...
      points: [
        ...
        "**Mieloma múltiple**: células plasmáticas que producen una inmunoglobulina monoclonal (**paraproteína**), rouleaux en sangre periférica. Síntomas **CRAB**: hiperCalcemia, daño Renal, Anemia y lesiones óseas (Bone). **MGUS** es el estado premieloma sin síntomas.",
      ],
    },
    {
